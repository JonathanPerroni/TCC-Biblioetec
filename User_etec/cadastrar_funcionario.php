...
<body class="w-100 h-auto d-flex flex-column align-itens-center">
    <header class="container-fluid d-flex justify-content-center align-items-center bg-white py-2 px-4 shadow">
        ...
        <a href="#" class="nav-link fs-3 fw-medium text-primary">Cadastrar Funcionário</a>
    </header>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $conn->prepare("INSERT INTO tbfuncionarios (nome, email, senha, telefone, celular, cpf, codigo_escola, acesso) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        if ($stmt->execute()) {
            ...
            echo "<p>Ocorreu um erro ao cadastrar o funcionário: " . $conn->error . "</p>";
        }
