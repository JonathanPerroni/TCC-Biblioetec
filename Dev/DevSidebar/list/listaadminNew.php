                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-cadastro" class="hidden py-2 space-y-2">
                            <li>
                                <a href="../../../User_etec/cadastrar_dev.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-[var(--primary)] dark:text-white dark:hover:bg-[var(--primary)]">Cadastrar Devs</a>
                            </li>
                            <li>
                                <a href="../../../User_etec/cadastrar_admin.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-[var(--primary)] dark:text-white dark:hover:bg-[var(--primary)]">Cadastrar Admins</a>
                            </li>
                            <li>
                                <a href="../../../User_etec/cadastrar_escola.php    " class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-[var(--primary)] dark:text-white dark:hover:bg-[var(--primary)]">Cadastrar Escolas</a>
                            </li>
                        </ul>
                    </li>
                </ul>
