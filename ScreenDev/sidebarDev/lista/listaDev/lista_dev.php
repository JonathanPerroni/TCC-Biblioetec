...
<main class="container">
    ...
    <!-- Dropdown -->
    <ul class="dropdown-menu">
        <li>  <div class="btn-acao1"><span class="btnEdit"><img src="data:image/png;base64,"></span> <a href="editar-dev.php?codigo=<?php echo $codigo; ?>" class="btn-text">Editar </a></div></li>
        <li> <div class="btn-acao1"><span class="btnDelet"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAXElEQVR4nGNgoAUQERNrExEV+ykiJv4fRAuLireQZoCo2E8+GRkhEBtEC4uK/SDCVvH/xGK8hjAQsISgKxiIoEcNGNyBKIpIgeiAqBQJSvPwPICOIXmiGa8BAwIAxCVRq6ihQTkAAAAASUVORK5CYII=" alt="Delete Icon"></span><a href="excluir-dev.php?codigo=<?php echo $codigo; ?>" class="btn-text">Excluir</a></div></li>
        <li><div class="btn-acao1">
