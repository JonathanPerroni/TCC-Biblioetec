            ...
            <table class="min-w-full text-sm text-left rtl:text-right text-[var(--secondary)]">
                <thead class="text-sm text-white uppercase bg-[var(--primary)] border border-[var(--primary-emphasis)]">
                    <tr class="">
                        ...
                        <th scope="col" class="px-6 py-3">Editora</th>
                ...
                <?php
                    ...
                    $sql = "SELECT codigo, titulo, categoria,classe, issn, editora, codigo_escola FROM tbjornal_revista";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr class="odd:bg-white even:bg-[var(--off-white)] border-b border-[var(--grey)]">
                                ...
                                <td class="px-6 py-4 border-r border-[var(--grey)]">' . htmlspecialchars($row["editora"]) . '</td>
                                ...
                                <td class="flex justify-between md:justify-evenly gap-1 px-6 py-4">
                                    ...
                                    <form id="form-excluir" action="../../excluir/acervo/revista.php" method="POST"><input value=' . urlencode($row["codigo"]) . ' readonly name="codigo" class="hidden"/> <button type="submit" class="font-medium text-red-600 hover:underline">Excluir</button></form>
                                </td>
                            </tr>';
                        }
                    } else {
