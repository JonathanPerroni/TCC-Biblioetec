        ...
        <div class="relative overflow-x-auto shadow-lg rounded-lg">
            <table class="min-w-full text-sm text-left rtl:text-right text-[var(--secondary)]">
                ...
                <?php
                    ...
                    $sql = "SELECT codigo, titulo, categoria, classe, data_edicao, codigo_escola FROM tbjogoseducativos";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr class="odd:bg-white even:bg-[var(--off-white)] border-b border-[var(--grey)]">
                                ...
                                <td class="px-6 py-4 border-r border-[var(--grey)]">' . htmlspecialchars($row["categoria"]) . '</td>
                                ...
                                <td class="flex justify-between md:justify-evenly gap-1 px-6 py-4">
                                    <a href="../../editar/acervo/jogos/editarJogos.php ?codigo=' . urlencode($row["codigo"]) . '" class="font-medium text-blue-600 hover:underline">Editar</a>
                                    <form id="form-excluir" action="../../excluir/acervo/jogo.php" method="POST"><input value=' . urlencode($row["codigo"]) . ' readonly name="codigo" class="hidden"/> <button type="submit" class="font-medium text-red-600 hover:underline">Excluir</button></form>
                                </td>
                            </tr>';
                        }
                    } else {
