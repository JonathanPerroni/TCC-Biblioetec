...
if ($cpfErro !== true) {
    ...
    $queryCpf = "SELECT COUNT(*) FROM tbprofessores WHERE cpf = ? AND codigo != ?";
...
if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    $queryEmail = "SELECT COUNT(*) FROM tbprofessores WHERE email = ? AND codigo != ?";
...
if (!empty($_SESSION['msg'])) {
    header("Location: editarProfessor.php?codigo=" . urlencode($codigo));
    exit();
}
