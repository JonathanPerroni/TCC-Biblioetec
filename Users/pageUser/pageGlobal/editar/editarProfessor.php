...
if (isset($_GET['codigo'])) {
    ...
    $sql = "SELECT * FROM tbprofessores WHERE codigo = $codigo";
...
<body class="w-100 h-auto d-flex flex-column align-items-center">
    <header class="container-fluid d-flex justify-content-center align-items-center bg-white py-2 px-4 shadow">
        <a href="../list/listaprofessorNew.php" class="d-flex align-items-center position-absolute start-0 ms-4 nav-link">
 ...
 <p class="text-primary">   <?php
    ...
    <form action=" attProfessor.php" method="POST" class="d-flex flex-column gap-4  ">
    ...
    <div class="breakable-row d-flex justify-between gap-4 flex-wrap"">
        <div class="w-100">
            ...
            <select name="acesso" id="acesso" required class="form-select">
                <option value="professor"><?php echo htmlspecialchars($row['acesso']);?></option>
            </select>  
        </div>
        <div class="w-100">
