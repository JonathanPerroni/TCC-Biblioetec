...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlSelect = "SELECT nome, acesso FROM tbprofessores WHERE codigo = ?";
    ...
    $sqlDelete = "DELETE FROM tbprofessores WHERE codigo = ?";
    ...
    if ($stmtDelete->execute()) {
        ...
        echo "<script>
            alert('O Professor  \"$nome_usuario\" foi excluído com sucesso!');
            window.location.href = '../list/listaprofessorNew.php';
        </script>";
    } else {
