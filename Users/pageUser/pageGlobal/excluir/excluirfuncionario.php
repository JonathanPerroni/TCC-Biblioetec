...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlSelect = "SELECT nome, acesso FROM tbfuncionarios WHERE codigo = ?";
    ...
    $sqlDelete = "DELETE FROM tbfuncionarios WHERE codigo = ?";
    ...
    if ($stmtDelete->execute()) {
        ...
        echo "<script>
            alert('O Funcionario(a)  \"$nome_usuario\" foi excluído com sucesso!');
            window.location.href = '../list/listafuncionarioNew.php';
        </script>";
    } else {
